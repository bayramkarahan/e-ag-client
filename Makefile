...
CXXFLAGS      = -pipe -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -std=gnu++11 -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
...
DIST          = e-ag-client.service \
		...
		e-ag-client.pro client.h \
		filecrud.h \
		singleinstance.h main.cpp \
		client.cpp \
		singleinstance.cpp
QMAKE_TARGET  = e-ag-client
DESTDIR       = 
TARGET        = e-ag-client
...
Makefile: e-ag-client.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/lex.prf \
		e-ag-client.pro
	$(QMAKE) -o Makefile e-ag-client.pro 'QMAKE_CFLAGS_RELEASE=-g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2' 'QMAKE_CFLAGS_DEBUG=-g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2' 'QMAKE_CXXFLAGS_RELEASE=-g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2' 'QMAKE_CXXFLAGS_DEBUG=-g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2' QMAKE_LFLAGS_RELEASE=-Wl,-z,relro QMAKE_LFLAGS_DEBUG=-Wl,-z,relro QMAKE_STRIP=: PREFIX=/usr
/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf:
/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf:
/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf:
/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf:
...
distdir: FORCE
	...
	$(COPY_FILE) --parents client.h filecrud.h singleinstance.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp client.cpp singleinstance.cpp $(DISTDIR)/
...
moc_predefs.h: /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/data/dummy.cpp
	g++ -pipe -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -std=gnu++11 -Wall -Wextra -dM -E -o moc_predefs.h /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/data/dummy.cpp
...
moc_client.cpp: client.h \
		...
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /home/etapadmin/Masaüstü/e-ag-client/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++ -I/home/etapadmin/Masaüstü/e-ag-client -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtNetwork -I/usr/include/x86_64-linux-gnu/qt5/QtDBus -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/12 -I/usr/include/x86_64-linux-gnu/c++/12 -I/usr/include/c++/12/backward -I/usr/lib/gcc/x86_64-linux-gnu/12/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include client.h -o moc_client.cpp
...
uninstall_service: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/lib/systemd/system/e-ag-client.service
...
uninstall_x11passwd: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/bin/x11vncpasswd
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/bin/ 
...
uninstall_runfile: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/bin/e-ag-run.sh
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/bin/ 
...
uninstall_webdisablefile: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/e-ag/webdisable.sh
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/e-ag/ 


install: install_target install_service install_x11servicedesktop install_x11servicelogin install_x11passwd install_runfile install_webdisablefile  FORCE

uninstall: uninstall_target uninstall_service uninstall_x11servicedesktop uninstall_x11servicelogin uninstall_x11passwd uninstall_runfile uninstall_webdisablefile  FORCE
